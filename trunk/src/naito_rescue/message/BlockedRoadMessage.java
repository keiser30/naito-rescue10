...
public class BlockedRoadMessage extends NAITOBaseMessage
{
	...
	public BlockedRoadMessage(){
		...
		// 設定する必要がある
		this.type = MessageType.BLOCKED;
	}
	public BlockedRoadMessage(int[] ids){
		this();
		setIDs(ids);
	}
	public BlockedRoadMessage(List<EntityID> list){
		this();
		setIDs(list);
	}
	public BlockedRoadMessage(EntityID id){
		this();
