...
public class HelpMeMessage extends naito_rescue.message.Message
{
	private EntityID clearTarget;
	
	public HelpMeMessage(int id, int addrAgent, int addrType, boolean broadcast, EntityID target){
